            ...
            <li className='editareaofuser' key={scholarship.id}>
              <div className='usernumberdiv'>
                <div className='leftsidecontentscholarship'>
                  <strong>Title:</strong> {scholarship.scholarshipTitle}<br />
                  <strong>Type:</strong> {scholarship.scholarshipType}<br />
                  <strong>Amount:</strong> {scholarship.scholarshipAmount}<br />
                  <strong>Criteria:</strong> {scholarship.eligibilityCriteria}
                </div>
